...
captured: "2026-06-14T13:28:36.550963+00:00"
---
...
## Work with the Codex app### [Multitask across projects](https://developers.openai.com/codex/app/features#multitask-across-projects)

[

Run project threads side by side and switch between them quickly.

](https://developers.openai.com/codex/app/features#multitask-across-projects)### Worktrees

Keep parallel code changes isolated with built-in Git worktree support.

[View original](https://developers.openai.com/codex/app/worktrees)### Remote connections

Use the ChatGPT mobile app to start, steer, approve, and review Codex work on a connected host.

[View original](https://developers.openai.com/codex/remote-connections)### Computer use

Let Codex use macOS apps for GUI tasks, browser flows, and native app testing.

[View original](https://developers.openai.com/codex/app/computer-use)### Appshots

Send the frontmost Mac app window to Codex with a screenshot and available text.

[View original](https://developers.openai.com/codex/appshots)### Review and ship changes

Inspect diffs, address PR feedback, stage files, commit, and push.

[View original](https://developers.openai.com/codex/app/review)### Terminal and actions

Run commands in each thread and launch repeatable project actions.

[View original](https://developers.openai.com/codex/app/features#integrated-terminal)### In-app browser

Open rendered pages, leave comments, or let Codex operate local browser flows.

[View original](https://developers.openai.com/codex/app/browser)### Chrome extension

Add the Chrome plugin so Codex can use Chrome for signed-in browser tasks while you manage website approvals.

[View original](https://developers.openai.com/codex/app/chrome-extension)### Image generation

Generate or edit images in a thread while you work on the surrounding code and assets.

[View original](https://developers.openai.com/codex/app/features#image-generation)### Automations

Schedule recurring tasks, or wake up the same thread for ongoing checks.

[View original](https://developers.openai.com/codex/app/automations)### Skills

Reuse instructions and workflows across the app, CLI, and IDE Extension.

[View original](https://developers.openai.com/codex/app/features#skills-support)### Sidebar and artifacts

Follow plans, sources, task summaries, and generated file previews.

[View original](https://developers.openai.com/codex/app/features#richer-outputs-and-artifacts)### Plugins

Connect apps, skills, and MCP servers to extend what Codex can do.

[View original](https://developers.openai.com/codex/plugins)### Sites

Build and deploy hosted websites, web apps, and games with the Sites plugin.

[View original](https://developers.openai.com/codex/sites)### IDE Extension sync

Share Auto Context and active threads across app and IDE sessions.

[View original](https://developers.openai.com/codex/app/features#sync-with-the-ide-extension)
