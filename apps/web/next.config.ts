...
const nextConfig: NextConfig = {
  env: {
    NEXT_PUBLIC_CODEX_REMOTE_CONTROL_PLANE_BASE_URL:
      process.env.NEXT_PUBLIC_CODEX_REMOTE_CONTROL_PLANE_BASE_URL ?? process.env.NEXT_PUBLIC_CODEX_REMOTE_WORKER_BASE_URL ?? "http://127.0.0.1:8786",
    NEXT_PUBLIC_CODEX_REMOTE_CONTROL_PLANE_TOKEN:
      process.env.NEXT_PUBLIC_CODEX_REMOTE_CONTROL_PLANE_TOKEN ?? process.env.NEXT_PUBLIC_CODEX_REMOTE_WORKER_TOKEN ?? "",
