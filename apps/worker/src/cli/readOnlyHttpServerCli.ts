...
function createSessionClient(
  ...
  return {
    ...
    resumeThread: (params) => client.resumeThread(params),
    archiveThread: (params) => client.archiveThread(params),
    unarchiveThread: (params) => client.unarchiveThread(params),
    setThreadName: (params) => client.setThreadName(params),
